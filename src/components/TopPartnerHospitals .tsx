      ...
      <Container className="py-16">
        ...
        <div className="grid gap-8 md:grid-cols-2">
          {hospitalData.map((countryBlock, idx) => (
            <div
              key={countryBlock.country}
              className="relative bg-white rounded-2xl p-6 md:p-7 shadow-[0_8px_30px_rgba(15,23,42,0.07)]"
            >
              {/* Card header */}
              ...
              {/* View all */}
              <button className="mt-6 w-full py-3 rounded-full bg-amber-500 text-white text-sm font-semibold hover:bg-amber-600 transition">
                View All
              </button>
