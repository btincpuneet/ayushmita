        ...
        <div className="flex flex-col md:flex-row gap-4">
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center gap-3 mt-4 flex-wrap">
              <button onClick={() => setIsModalOpen(true)} className="px-5 py-2 rounded-md bg-yellow-500 text-white font-medium hover:bg-yellow-600 transition">
                Book Appointment
              </button>
...
>>>>>>> dcb8dfb992458f4013dea5350727c71d1344311e
        </div>
      </article>
      <ModalAppointment
        isOpen={isModalOpen}
