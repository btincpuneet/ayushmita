...
//       if (value.trim().length > 50) error = "Maximum 50 characters allowed";
//     }
...
//     if (name === "treatment") {
//       if (value.trim().length < 3) error = "Minimum 3 characters required";
...
//       setErrors({});
//     } catch (error) {
//       alert("Failed to submit consultation form");
//     } finally {
//       setLoading(false);
//     }
//   };
...
//               Submit the form and our health expert will reach out within 24
//               hours.
//             </p>
//           </div>
//         </div>
...
//               <input name="phoneNumber" value={formData.phoneNumber}maxLength={10} onChange={handleChange} className="p-2 rounded bg-white text-black w-full" />
