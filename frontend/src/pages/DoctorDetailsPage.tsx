...
const DoctorDetailsPage: React.FC = () => {
        ...
        const loadData = async () => {
            try {
                const doctorRes = await axios.get(
                    (()=>{const VITE_BASE=(import.meta as any).env?.VITE_BASE_URL;const BASE=VITE_BASE?VITE_BASE.replace(/\/$/,""):"";return `${BASE}/api/doctors/${slug}`})()
                );

                const listRes = await axios.get(
                    (()=>{const VITE_BASE=(import.meta as any).env?.VITE_BASE_URL;const BASE=VITE_BASE?VITE_BASE.replace(/\/$/,""):"";return `${BASE}/api/doctors`})()
                );
    ...
    const image = doctor.image_url
        ? (()=>{const VITE_BASE=(import.meta as any).env?.VITE_BASE_URL;const BASE=VITE_BASE?VITE_BASE.replace(/\/$/,""):"";return `${BASE}${doctor.image_url}`})()
                                    ...
                                    <div key={d.id} className="px-3" >
                                        <div className="bg-white rounded-xl shadow text-center">
                                            <img
                                                src={
                                                    d.image_url
                                                        ? (()=>{const VITE_BASE=(import.meta as any).env?.VITE_BASE_URL;const BASE=VITE_BASE?VITE_BASE.replace(/\/$/,""):"";return `${BASE}${d.image_url}`})()
                                                        : image
                                                }
